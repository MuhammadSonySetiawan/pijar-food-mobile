...
function homeScreen(props) {
  ...
  React.useEffect(() => {
    axios
    .get('https://pijar-food-be.onrender.com/v1/recipe/all')
...
<PaperProvider>
          ...
          <View style={{ backgroundColor: '##EFEFEF', height: '100%',padding:15 }}>
                          <ScrollView >
                            ...
                            <View style={{ marginTop: 5 }}>
                              ...
                              <Text variant="labelMedium" style={{ fontSize: 14, marginTop: 5 }}>
                                Populer check
                              </Text>
                            </View>
                            ...
                            {recipes.map((item, key) => (
                                <TouchableOpacity key={key}
                                  ...
                                  <Card
                                    ...
                                    />
                                    <Card.Content>
                                    <Text variant="titleLarge" numberOfLines={1}>{item.name}</Text>
                                    <Text variant="bodyMedium" numberOfLines={1}>{item?.ingridients ?? 'ingridient not found'}
                                      </Text>
                                    </Card.Content>
                                  </Card>
                                </TouchableOpacity>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity onPress={() => navigation.navigate('EddRecipes')}>
              <Icon2 name='plus-square' size={35} color='#666666' style={{ marginLeft: 21 }} />
